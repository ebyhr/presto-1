...
public class RangerPluginInitializer
{
    ...
    private static void addRequiredResource(final String configFileName)
            throws IOException
    {
    ...
    private static void handleKerberos(RangerConfiguration rangerConfig, Map<String, String> config)
            throws IOException
    {
            ...
            List<String> appId)
    {
        ...
        if (Boolean.parseBoolean(configuration.getOrDefault(RANGER_GROUP_FETCH, "true"))) {
